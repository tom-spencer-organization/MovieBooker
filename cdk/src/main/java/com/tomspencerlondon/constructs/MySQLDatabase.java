package com.tomspencerlondon.constructs;
...
/**
 * Creates a MySQL database in the isolated subnets of a given VPC.
 * <p>
 ...
 */
public class MySQLDatabase extends Construct {
  ...
  public MySQLDatabase(
    ...
    dbInstance = CfnDBInstance.Builder.create(this, "mysqlInstance")
      ...
      .engine("mysql")
      .engineVersion(databaseInputParameters.mySQLVersion)
  ...
  /**
   * Collects the output parameters of an already deployed {@link MySQLDatabase} construct from the parameter store. This requires
   * that a {@link MySQLDatabase} construct has been deployed previously. If you want to access the parameters from the same
   * stack that the {@link MySQLDatabase} construct is in, use the plain {@link #getOutputParameters()} method.
   *
   * @param scope       the construct in which we need the output parameters
   * @param environment the environment for which to load the output parameters. The deployed {@link MySQLDatabase}
  ...
  public static class DatabaseOutputParameters {
    ...
    /**
     * The database name of the MySQL instance.
     */
